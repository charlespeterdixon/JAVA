...
public class Runner {
	...
	/*
	 * This LinkedList not only deletes a single occurrence of the element but also
	 * asks the user whether he would like to delete all the occurrences except one.
	 */
